...
ROS3D.OrbitControls = function(options) {
  ...
  document.getElementById("button_zoom_in").onclick = function() { 
       that.zoomIn(); 
  };
   document.getElementById("button_zoom_out").onclick = function() { 
       that.zoomOut(); 
  };
  document.getElementById("button_move").onclick = function() { 
    console.log("move");
    document.getElementById("button_focus").disabled = false;
    document.getElementById("button_move").disabled = true;
    moveButton = true;
  };
  document.getElementById("button_focus").onclick = function() { 
    console.log("focus");
    document.getElementById("button_focus").disabled = true;
