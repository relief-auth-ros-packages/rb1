...
$(document).ready(function() {
        ...
        //to see the person marker
        var PersonMarkerClient = new ROS3D.MarkerArrayClient({
			ros : ros,
			rootObject : viewer.scene,
			tfClient : tfClient,
			topic: namespace+'/person_followed_marker'
          });

        //to see the cart marker
        var PersonMarkerClient = new ROS3D.MarkerArrayClient({
			ros : ros,
			rootObject : viewer.scene,
			tfClient : tfClient,
			topic: namespace+'/two_tag_laser_locator_node/cart_detected_marker'
		  });
        //readPOIs();
...
var autoReloadActive;
function autoReload (reload){
	autoReloadActive = reload;
...
map_nav_state_sub.subscribe(function(message) {
   ...
   if(mapping){
       ...
       try{
           document.getElementById("button_save_map").disabled = false || disable_all_buttons;
           document.getElementById("button_start_mapping").disabled = true || disable_all_buttons;
           document.getElementById("button_stop_mapping").disabled = false || disable_all_buttons;
       }catch(e){
       ...
       try{
           document.getElementById("button_save_map").disabled = true || disable_all_buttons;
           document.getElementById("button_start_mapping").disabled = false || disable_all_buttons;
           document.getElementById("button_stop_mapping").disabled = true || disable_all_buttons;
       }catch(e){
   ...
   if(navigation){
       ...
       document.getElementById("button_start_navigation").disabled = true || disable_all_buttons;
       document.getElementById("button_stop_navigation").disabled = false || disable_all_buttons;
   }else{
       document.getElementById("navigation_status").style.color = "Red";
       document.getElementById("button_start_navigation").disabled = false || disable_all_buttons;
       document.getElementById("button_stop_navigation").disabled = true || disable_all_buttons;
   }
   if(localization){
       autoReload (false);
       document.getElementById("localization_status").style.color = "Green";
       try{
           document.getElementById("button_start_localization").disabled = true || disable_all_buttons;
           document.getElementById("button_stop_localization").disabled = false || disable_all_buttons;
       }catch(e){
       ...
       try{
           document.getElementById("button_start_localization").disabled = false || disable_all_buttons;
           document.getElementById("button_stop_localization").disabled = true || disable_all_buttons;
       }catch(e){
   ...
   if(map_server){
       ...
       try{
           document.getElementById("button_start_map_server").disabled = true || disable_all_buttons;
           document.getElementById("button_stop_map_server").disabled = false || disable_all_buttons;
       }catch(e){
       ...
       try{
           document.getElementById("button_start_map_server").disabled = false || disable_all_buttons;
           document.getElementById("button_stop_map_server").disabled = true || disable_all_buttons;
       }catch(e){
