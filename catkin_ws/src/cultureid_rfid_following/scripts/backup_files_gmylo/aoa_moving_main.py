def track(input_path, EPC_str, past_estimation, antenna_poses):
        ...
        if input_lines:
            ...
            for line in input_lines:
                ...
                if results.__len__() > 4:
                    #if not timestamp_check and input_lines - idx < data_window:
                        #timestamp_check = True
                        #timestamp.append(idx)
                        #timestamp.pop(0)
                    #if input_lines.__len__() - idx < data_window:
                        #input_file.write(line)
                        #input_file.write("\n")
                    idx += 1
                    if input_lines.__len__() - idx < rssi_N:
